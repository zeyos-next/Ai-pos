...
class InventoryPage:
    def __init__(self, account_window):
        ...
        account_window.title("zeyos pos")

        # window Icon
        icon = PhotoImage(file='images\\logo.png')
        account_window.iconphoto(True, icon)

        account_window.config(background='#fff')

        # ====== MENU BAR ==========
        logoIcon = Image.open('images\\slogo.jpg').resize((50,50))
        photo = ImageTk.PhotoImage(logoIcon)
        logo = Label(account_window, image=photo, bg='#fff')
        logo.image = photo
        ...
        admLabel = Label(account_window, text='ADMIN', font=('yu gothic ui', 18, 'bold'), fg='#000', bg='#fff')
        admLabel.place(relx = 0.9, y=11)

        # ========== HOME BUTTON =======
        home_button = Button(account_window, text='Home', bg='#fff', font=("", 13, "bold"), bd=0, fg='#000',
        ...
        # ========== MANAGE BUTTON =======
        manage_button = Button(account_window, text='Manage', bg='#6DA3C0', font=("", 13, "bold"), bd=0, fg='#ffffff',
                               cursor='hand2', activebackground='#6DA3C0', activeforeground='#fff')
        manage_button.place(x=150, y=15)

        # ========== PRODUCTS BUTTON =======
        product_button = Button(account_window, text='Products', bg='#fff', font=("", 13, "bold"), bd=0, fg='#000',
                                cursor='hand2', activebackground='#6DA3C0', activeforeground='#fff',
        ...
        help_button = Button(account_window, text='Help', bg='#fff', font=("", 13, "bold"), bd=0, fg='#000',
                             cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a', command=help)
        ...
        # ========== LOG OUT =======
        logout_button = Button(account_window, text='Logout', bg='#fff', font=("", 13, "bold"), bd=0, fg='#000',
                               cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a',
                               command=logout)
        ...
        button6.configure(background="#6DA3C0")
        ...
        def upgrade_admin():
            ...
            cur.execute("SELECT admin_id FROM Admin_Account WHERE admin_id = ?", (admin_id.get(),))
            result = cur.fetchone()

            if result is None:
                # Insert the new admin record if admin_id does not exist
                ...
                # Handle the case where admin_id already exists
                messagebox.showerror("Error", "Admin ID already exists. Please use a unique Admin ID.")
    ...
    # # problem
    #     self.scrollbary.place(relx=0.37, rely=0.203, width=22, height=84)
    #     self.scrollbarx.place(relx=0.020, rely=0.40, width=84, height=22)
        ...
        self.button6.configure(activebackground="#6DA3C0")
