...
class FirstPage:
    def __init__(self, dashboard_window):
        ...
        admLabel =ctk.CTkLabel(homepage, text='ADMIN', font=('yu gothic ui', 18, 'bold'), fg_color="white",text_color="black")
        admLabel.place(relx=0.9, y=11)

        frame = ctk.CTkFrame(homepage, corner_radius=15, fg_color="transparent",bg_color="transparent")
        frame.place(relx=0.5, rely=0.5, anchor="center")

        # Add the label inside the frame with internal padding
        heading = ctk.CTkLabel(frame, text='Welcome to \nZeyos POS', font=("yu gothic ui", 28, "bold"), text_color="#000",bg_color="transparent")
