    ...
    def __init__(self, manage_page):
        ...
        class Manage:
            def __init__(self, Manage_window):
                ...
                # =================== HOME PAGE ========================================================
                # ======================================================================================
                product_page.config(background='#fff')
                ...
                admLabel = Label(product_page, text='ADMIN', font=('yu gothic ui', 18, 'bold'), fg='black', bg='white')
                admLabel.place(relx=0.9, y=11)

                # ========== HOME BUTTON =======
                home_button = Button(product_page, text='Home', bg='white', font=("", 13, "bold"), bd=0, fg='#000',
                                     cursor='hand2', activebackground='#6DA3C0', activeforeground='#000',
                                     command=lambda: home())
                ...
                # ========== MANAGE BUTTON =======
                manage_button = Button(product_page, text='Manage', bg='#6DA3C0', font=("", 13, "bold"), bd=0,
                                       fg='#ffffff',
                                       cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a')
                manage_button.place(x=150, y=15)

                # ========== PRODUCTS BUTTON =======
                product_button = Button(product_page, text='Products', bg='white', font=("", 13, "bold"), bd=0,
                                        fg='#000',
                                        cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a',
                ...
                help_button = Button(product_page, text='Help', bg='white', font=("", 13, "bold"), bd=0,
                                     fg='#000', command=help,
                                     cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a')
                ...
                # ========== LOG OUT =======
                logout_button = Button(product_page, text='Logout', bg='white', font=("", 13, "bold"), bd=0,
                                       fg='#000',
                                       cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a',
                                       command=logout)
                ...
                self.button6.configure(background="#6DA3C0")
                ...
                # Manage Coffee Label
                manageCoffee = Label(coverFrame2, text='Manage products', font=("yu gothic ui", 18, "bold"), bg='#ffffff',
                                     fg='#000')
                manageCoffee.place(relx = 0.2, y=0)

                coverFrame3 = LabelFrame(coverFrame2, bg='#ffffff', bd='2.4')
                coverFrame3.place(x=20, y=80, width=270, height=475)
                # hello
                # Coffee Image
                ...
                idName_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#000",
                                         font=("", 11, 'bold'), textvariable=coffee_id)
                idName_entry.place(x=22, y=44, width=40, height=24)
                idName_entry.config(highlightbackground="#000", highlightcolor="#6DA3C0")
                ...
                coffeeName_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6DA3C0",
                                         font=("", 12, 'bold'), textvariable=coffee)
                coffeeName_entry.place(x=10, y=70, width=225, height=34)
                coffeeName_entry.config(highlightbackground="#000", highlightcolor="#6DA3C0")

                # COFFEE TYPE AND ENTRY
                typeLabel = Label(coverFrame3, text="TYPE", bg='#ffffff', font=("yu gothic ui", 12, "bold"))
                typeLabel.place(x=90, y=105)

                typeName_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6DA3C0",
                                       font=("", 12, 'bold'), textvariable=type)
                typeName_entry.place(x=10, y=135, width=225, height=34)
                typeName_entry.config(highlightbackground="#000", highlightcolor="#6DA3C0")
                ...
                discountName_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6DA3C0",
                                         font=("", 12, 'bold'), textvariable=discount)
                discountName_entry.place(x=10, y=200, width=225, height=34)
                discountName_entry.config(highlightbackground="#000", highlightcolor="#6DA3C0")

                # IN STOCK AND ENTRY
                inStockLabel = Label(coverFrame3, text="IN STOCK", bg='#ffffff', font=("yu gothic ui", 12, "bold"))
                inStockLabel.place(x=90, y=240)

                inStock_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6DA3C0",
                                      font=("", 12, 'bold'), textvariable=in_stock)
                inStock_entry.place(x=10, y=270, width=225, height=34)
                inStock_entry.config(highlightbackground="#000", highlightcolor="#6DA3C0")

                # PRICE AND ENTRY
                priceLabel = Label(coverFrame3, text="PRICE", bg='#ffffff', font=("yu gothic ui", 12, "bold"))
                priceLabel.place(x=90, y=310)

                price_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6DA3C0",
                                    font=("", 12, 'bold'), textvariable=price)
                price_entry.place(x=80, y=340, width=100, height=34)
                price_entry.config(highlightbackground="#000", highlightcolor="#6DA3C0")

                currencyLabel = Label(coverFrame3, text="AED", bg='#ffffff', font=("yu gothic ui", 14, "bold"))
                currencyLabel.place(relx = 0.1, rely=.72)
                ...
                self.button3.configure(background="#6DA3C0")
                ...
                self.button4.configure(background="#6DA3C0")
                ...
                self.button5.configure(background="#6DA3C0")
        ...
        class BillWindow:
            def __init__(self, top=None):
                ...
                logoIcon = Image.open('images\\logo.png').resize((50,50))
                photo = ImageTk.PhotoImage(logoIcon)
                logo = Label(biller, image=photo, bg='#fff')
                logo.image = photo
                logo.place(x=5, y=0)
                ...
                admLabel =Label(biller, text='ADMIN', font=('yu gothic ui', 18, 'bold'), fg='#000', bg='#fff')
                admLabel.place(relx = 0.9, y=11)

                # ========== HOME BUTTON =======
                home_button = Button(biller, text='Home', bg='#fff', font=("", 13, "bold"), bd=0, fg='#000',
                                     cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a',
                                     command=lambda: home())
                home_button.place(x=70, y=15)
                ...
                # ========== MANAGE BUTTON =======
                manage_button = Button(biller, text='Manage', bg='#fff', font=("", 13, "bold"), bd=0,
                                       fg='#000',
                                       cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a')
                manage_button.place(x=150, y=15)

                # ========== PRODUCTS BUTTON =======
                product_button = Button(biller, text='Products', bg='#fff', font=("", 13, "bold"), bd=0,
                                        fg='#000',
                                        cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a',
                                        command=lambda: product())
                product_button.place(x=250, y=15)
                ...
                help_button = Button(biller, text='Help', bg='#fff', font=("", 13, "bold"), bd=0,
                                     fg='#000', command=help,
                                     cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a')
                help_button.place(x=360, y=15)
                ...
                # ========== LOG OUT =======
                logout_button = Button(biller, text='Logout', bg='#fff', font=("", 13, "bold"), bd=0,
                                       fg='#000',
                                       cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a',
                                       command=logout)
                logout_button.place(x=420, y=15)
                ...
                self.coverFrame2.place(x=0, y=80, width=600, height=645)
                ...
                self.coverFrame5.place(relx = 0.78, y=235, width=300, height=490)
                ...
                self.genBill_no = Label(self.coverFrame6, text='Bill Number', font=("yu gothic ui", 10, "bold"),
                                        bg='#ffffff', fg='#000000')
                self.genBill_no.place(relx=0.180, rely=0.049)
                ...
                self.clock.place(relx=.018, rely=0.105, width=102, height=36)
                self.clock.configure(font="-family {Poppins Light} -size 12")
                self.clock.configure(foreground="#000000")
                self.clock.configure(background="#ffffff")

                self.quantity = Label(self.coverFrame2)
                self.quantity.place(relx = 0.075,rely = 0.65)
                ...
                self.coffee_name = Label(self.coverFrame2)
                self.coffee_name.place(relx = 0.075, rely=0.55)
                ...
                self.discount = Label(self.coverFrame2)
                self.discount.place(relx = 0.075, rely =.45)
                ...
                self.payment_method = Label(self.coverFrame2)
                self.payment_method.place(relx = 0.075, rely=.36)
                ...
                self.company_number = Label(self.coverFrame2)
                self.company_number.place(relx = 0.075, rely = 0.28)
                self.company_number.configure(font="-family {Poppins Bold} -size 11")
                ...
                self.cashier_name = Label(self.coverFrame2)
                self.cashier_name.place(relx = 0.075,rely = 0.18)
                self.cashier_name.configure(font="-family {Poppins Bold} -size 11")
                ...
                # cashier name
                self.entry1 = ttk.Entry(self.coverFrame2)
                self.entry1.place(relx=0.075, rely=0.23, width=477, height=24)
                self.entry1.configure(font="-family {Poppins} -size 12")
                self.entry1.configure(textvariable=cust_name)

                self.entry2 = ttk.Entry(self.coverFrame2)
                self.entry2.place(relx=0.075, rely=0.32, width=477, height=24)
                ...
                self.entry3.configure(highlightbackground="#6DA3C0", highlightcolor="#000")
                ...
                search = Label(biller, image=photo, bg='#fff')
                search.image = photo
                search.place(relx=0.38, rely=0.019)

                self.button2 = Button(biller)
                self.button2.place(relx=0.62, rely=0.019, width=76, height=29)
                self.button2.configure(relief="flat")
                self.button2.configure(overrelief="flat")
                self.button2.configure(activebackground="#6DA3C0")
                self.button2.configure(cursor="hand2")
                self.button2.configure(foreground="#ffffff")
                self.button2.configure(background="#6DA3C0")
                ...
                self.button3 = Button(self.coverFrame4)
                self.button3.place(relx=0.085, rely=0.4, width=86, height=25)
                self.button3.configure(relief="flat")
                self.button3.configure(overrelief="flat")
                self.button3.configure(activebackground="#6DA3C0")
                self.button3.configure(cursor="hand2")
                self.button3.configure(foreground="#ffffff")
                self.button3.configure(background="#6DA3C0")
                self.button3.configure(font="-family {Poppins SemiBold} -size 10")
                ...
                self.button4 = Button(self.coverFrame4)
                self.button4.place(relx=0.3, rely=0.4, width=84, height=25)
                self.button4.configure(relief="flat")
                self.button4.configure(overrelief="flat")
                self.button4.configure(activebackground="#6DA3C0")
                self.button4.configure(cursor="hand2")
                self.button4.configure(foreground="#ffffff")
                self.button4.configure(background="#6DA3C0")
                self.button4.configure(font="-family {Poppins SemiBold} -size 10")
                ...
                self.button5 = Button(self.coverFrame4)
                self.button5.place(relx=0.52, rely=0.4, width=86, height=25)
                self.button5.configure(relief="flat")
                self.button5.configure(overrelief="flat")
                self.button5.configure(activebackground="#6DA3C0")
                self.button5.configure(cursor="hand2")
                self.button5.configure(foreground="#ffffff")
                self.button5.configure(background="#6DA3C0")
                self.button5.configure(font="-family {Poppins SemiBold} -size 10")
                ...
                self.button7 = Button(self.coverFrame2)
                self.button7.place(relx=0.20, rely=0.78, width=86, height=26)
                self.button7.configure(relief="flat")
                self.button7.configure(overrelief="flat")
                self.button7.configure(activebackground="#6DA3C0")
                self.button7.configure(cursor="hand2")
                self.button7.configure(foreground="#ffffff")
                self.button7.configure(background="#6DA3C0")
                ...
                self.button8 = Button(self.coverFrame2)
                self.button8.place(relx=0.58, rely=0.78, width=84, height=26)
                self.button8.configure(relief="flat")
                self.button8.configure(overrelief="flat")
                self.button8.configure(activebackground="#6DA3C0")
                self.button8.configure(cursor="hand2")
                self.button8.configure(foreground="#fff")
                self.button8.configure(background="#6DA3C0")
                ...
                self.button9 = Button(self.coverFrame2)
                self.button9.place(relx=0.4, rely=0.78, width=68, height=26)
                self.button9.configure(relief="flat")
                self.button9.configure(overrelief="flat")
                self.button9.configure(activebackground="#6DA3C0")
                self.button9.configure(cursor="hand2")
                self.button9.configure(foreground="#ffffff")
                self.button9.configure(background="#6DA3C0")
                ...
                style = ttk.Style()
                style.theme_use("clam")
                self.combo1 = ttk.Combobox(self.coverFrame2)
                self.combo1.place(relx=0.075, rely=0.4, width=477, height=26)
                ...
                self.combo1.option_add("*TCombobox*Listbox.selectBackground", "#6DA3C0")
                #self.combo1.bind('<1>', self.entry1)

                self.combo2 = ttk.Combobox(self.coverFrame2)
                self.combo2.place(relx=0.075, rely=0.5, width=477, height=26)
                ...
                self.combo3 = ttk.Combobox(self.coverFrame2)
                self.combo3.place(relx=0.075, rely=0.6, width=477, height=26)
                ...
                self.entry4 = ttk.Entry(self.coverFrame2)
                self.entry4.place(relx=0.075, rely=0.7, width=477, height=26)
                self.entry4.configure(font="-family {Poppins SemiBold} -size 9")
                self.entry4.configure(foreground="#6DA3C0")
                ...
                head = "\n\n\t\t Reflection car care\n" \
                       "\t\t Ras al khaimah\n\n\t\t you had the best quality\n" \
                       "\t\t WE HOPE TO SEE YOU NEXT TIME\n\n\n" + "\tservice\t  -----  \tQUANTITY\t  -----  \tPRICE ( $ )\n"
                self.Scrolledtext1.insert('insert', head)

                self.combo1.bind("<<ComboboxSelected>>", self.get_category)

                btn_print = Button(self.coverFrame4, text="""Print""", command=lambda: print_area(self.Scrolledtext1.get('1.0', END)),
                                   overrelief="flat", bd=0, foreground="#ffffff", relief="flat", cursor="hand2",
                                   font="-family {Poppins SemiBold} -size 10", bg='#6DA3C0', activebackground="#6DA3C0")
                btn_print.place(relx=0.75, rely=0.4, width=86, height=25)
            ...
            def show_qty(self, Event):
                ...
                self.qty_label = Label(self.coverFrame2)
                self.qty_label.place(relx=0.062, rely=0.75, width=82, height=26)
                ...
                self.qty_label.configure(background="#fff")
