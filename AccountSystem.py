...
class AccountPage:
    def __init__(self, AccountSystem_window):
        ...
        AccountSystem_window.title('Zeyos pos login')
        ...
        logoIcon = logoIcon.resize((50,50),Image.Resampling.LANCZOS)
        photo = ImageTk.PhotoImage(logoIcon)
        logo = Label(landing_page, image=photo, bg='#ffffff')
        logo.image = photo
        logo.place(x=20, y=45)

        brand_name = Label(landing_page, text='welcome to zeyos pos', bg='#ffffff', fg='#6DA3C0', font=("yu gothic ui", 15, "bold"))
        brand_name.place(x=83, y=53)

        # text = Label(landing_page, text="FDA APPROVED", bg='#ffffff', font=("", 12, "bold"))
        # text.place(x=20, y=140)
        txt = "• We care for your privacy by all standards \n \n"
        text2 = Label(landing_page, text=txt,
                      fg="#6b6a69", bg='#ffffff', font=("", 11, "bold"))
        txt3 = "• the modern technology (but) combined with Ai"
        text3 = Label(landing_page,text = txt3,fg="#6b6a69", bg='#ffffff', font=("", 11, "bold"))
        text2.place(x=10, rely=0.4)
        text3.place(x = 10,rely = 0.45)
        ...
        # Login Button
        login_button = Button(landing_page, text='Login', bg='#6DA3C0', font=("", 13, "bold"), bd=0, fg='white',
                              cursor='hand2', activebackground='#505A92', activeforeground='white',
                              command=lambda: show_frame(sign_in))
        login_button.place(x=490, y=300)

        # Sign Up Button
        signUp_button = Button(landing_page, text='Create New Account', bg='#6DA3C0', font=("", 13, "bold"), bd=0, fg='white',
                               cursor='hand2', activebackground='#505A92', activeforeground='white',
        ...
        brand_name = Label(sign_in, text='zeyos pos', bg='white', fg='#6DA3C0', font=("", 15, "bold"))
        brand_name.place(x=90, y=60)

        # text = Label(sign_in, text="FDA APPROVED", bg='#ffffff', font=("", 12, "bold"))
        # text.place(x=20, y=140)
        text4 = Label(sign_in, text=txt,
                      fg="#6b6a69", bg='#ffffff', font=("", 11, "bold"))
        text5 = Label(sign_in,text = txt3,fg="#6b6a69", bg='#ffffff', font=("", 11, "bold"))
        text4.place(x=10, rely=0.4)
        text5.place(x = 10,rely = 0.45)
        ...
        loginButton = Button(sign_in, fg='#f8f8f8', text='Login', bg='#6DA3C0', font=("", 12, "bold"),
                             cursor='hand2', activebackground='#6DA3C0', command=login_all)
        ...
        createButton = Button(sign_in, fg='#f8f8f8', text='Create New Account', bg='#6DA3C0', font=("", 12, "bold"),
        ...
        def forgot_password():
            ...
            update_pass = Button(win, fg='#f8f8f8', text='Update Password', bg='#6DA3C0', font=("", 12, "bold"),
                                 cursor='hand2', activebackground='#6DA3C0', command=lambda: change_password())
        ...
        brand_name = Label(sign_up, text='zeyos pos login', bg='#ffffff', fg='#6DA3C0', font=("", 15, "bold"))
        brand_name.place(x=90, y=60)

        txt3 = " • We care for your privacy by all standards "
        text2 = Label(sign_up, text=txt3,
                      fg="#6b6a69", bg='#ffffff', font=("", 11, "bold"))
        txt3 = "• the modern technology (but) combined with Ai"
        text3 = Label(sign_up,text = txt3,fg="#6b6a69", bg='#ffffff', font=("", 11, "bold"))
        text2.place(x=6, rely=.4)
        text3.place(x = 10,rely = 0.45)
        # ====== LOGO ==========
        ...
        signupButton = Button(sign_up, fg='#f8f8f8', text='Create Account', bg='#6DA3C0', font=("", 12, "bold"),
                              cursor='hand2', activebackground='#6DA3C0', command=signup_all)
