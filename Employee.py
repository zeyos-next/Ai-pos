    ...
    def __init__(self, manage_page):
        ...
        class Manage:
            def __init__(self, Manage_window):
                ...
                admLabel = Label(product_page, text='EMPLOYEE', font=('yu gothic ui', 18, 'bold'), fg='black', bg='white')
                ...
                help_button = Button(product_page, text='Help', bg='#fff', font=("", 13, "bold"), bd=0, fg='#000',
                                     cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a',
                                     command=help)
        ...
        class BillWindow:
            def __init__(self, top=None):
                ...
                admLabel =Label(biller, text='EMPLOYEE', font=('yu gothic ui', 18, 'bold'), fg='#000', bg='#fff')
                admLabel.place(relx = 0.9, y=11)
                ...
                # ========== MANAGE BUTTON =======
                manage_button = Button(biller, text='Manage', bg='#6DA3C0', font=("", 13, "bold"), bd=0,
                                       fg='#fff',
                                       cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a')
                manage_button.place(x=150, y=15)
                ...
                help_button = Button(biller, text='Help', bg='#fff', font=("", 13, "bold"), bd=0, fg='#000',
            ...
            def show_qty(self, Event):
                ...
                self.qty_label.place(relx=0.033, rely=0.74, width=82, height=26)
