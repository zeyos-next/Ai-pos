...
class InventoryPage:
    def __init__(self, Manage_window):
        ...
        admLabel = Label(product_page, text='ADMIN', font=('yu gothic ui', 18, 'bold'), fg='#000', bg='#fff')
        admLabel.place(relx = 0.9, y=11)

        # ========== HOME BUTTON =======
        home_button = Button(product_page, text='Home', bg='#fff', font=("", 13, "bold"), bd=0, fg='#000',
        ...
        # ========== PRODUCTS BUTTON =======
        product_button = Button(product_page, text='Products', bg='#fff', font=("", 13, "bold"), bd=0,
                                fg='#000',
                                cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a',
        ...
        # ========== HELP BUTTON =======
        help_button = Button(product_page, text='Help', bg='#fff', font=("", 13, "bold"), bd=0,
                             fg='#000',
                             cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a')
        ...
        # ========== LOG OUT =======
        logout_button = Button(product_page, text='Logout', bg='#fff', font=("", 13, "bold"), bd=0,
                               fg='#000',
                               cursor='hand2', activebackground='#6DA3C0', activeforeground='#7a7a7a',
                               command=logout)
        ...
        self.button3.place(relx=0.580, rely=0.849, width=86, height=25)
        ...
        self.button6.place(relx=0.160, rely=0.849, width=86, height=25)
        self.button6.configure(relief="flat")
        self.button6.configure(overrelief="flat")
        self.button6.configure(activebackground="#6DA3C0")
        self.button6.configure(cursor="hand2")
